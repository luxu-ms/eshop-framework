...
namespace eShopLegacy.DAL
{
    public class OrderService
    {
        ...
        public Order CreateOrderFromBasket(string buyerId, string buyerName, Address shippingAddress, string cardNumber, string cardHolderName, DateTime cardExpiration, string cardSecurityNumber, int cardTypeId)
        {
